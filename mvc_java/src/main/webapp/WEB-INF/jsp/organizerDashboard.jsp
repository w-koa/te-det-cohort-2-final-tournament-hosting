...
<div class="col-md-8">
	...
	<%-- <c:if test="organizerTournaments.size() = 0">--%>
		...
		<p>Sample. Should show if no tournaments being hosted by this organizer</p>
		<h2>No tournaments hosted! Register a new tournament</h2>
		<c:url var="registerTournamentURL" value="/registerTournament" />
			...
			<form method="POST" action="${registerTournamentURL}"
				...
				<div class="radio">
					<label><input type="radio"
						class="optionsRadios" id="optionsRadios1" name="type" value="Single" checked>Single Elimination</label>
				</div>
				<div>
